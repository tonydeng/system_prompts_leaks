...
> 最后更新：2026-07-29 | 会话主题：system_prompts_leaks 中文镜像（-zh.md）批量生成
...
| OpenAI | 87 | 3 | 🔶 已开始：gpt-5.5-instant/gpt-5.3-instant/gpt-5.5-thinking 完成 |
| Google | 22 | 0 | ❌ 未开始 |
| xAI | 11 | 0 | ❌ 未开始 |
| Microsoft | 5 | 0 | ❌ 未开始 |
| Perplexity | 3 | 3 | ✅ 完成 |
...
- **后续厂商未开始**：OpenAI 已开始（3/87 完成），Google(22)/xAI(11)/Microsoft(5)/Misc(23) 共 61 文件待处理
